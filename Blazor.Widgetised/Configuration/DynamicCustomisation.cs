...
{
    public sealed class DynamicCustomisation<TModel> : DynamicObject, IDictionary<string, object>
    {
        private readonly Type modelType = typeof(TModel);
        private readonly Dictionary<string, DynamicProperty> properties;

        public DynamicCustomisation()
        {
            properties = BuildProperties();
        }

        public DynamicCustomisation(IDictionary<string, object> properties)
            : this()
        {
        ...
        private bool TrySetProperty(string name, object value)
        {
            ...
            throw new InvalidOperationException($"The property is type of {property.Type.FullName}.");
        }
        ...
        ICollection<object> IDictionary<string, object>.Values => properties.Values
            .Where(property => property.WasSet)
